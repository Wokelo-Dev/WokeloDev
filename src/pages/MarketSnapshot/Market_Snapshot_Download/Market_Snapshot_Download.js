...
import styles from "./Market_Snapshot_Download.module.css";
import { Link } from "react-router-dom";
import { AuthContext } from "../../../context/AuthContext";
import { HiOutlineLogout } from "react-icons/hi";
const Market_Snapshot_Download = () => {
  let { username, marketSnapshotResearch, globalEmailID } = useContext(AuthContext);
  return (
    <div>
      <Sidebar />
            ...
            <div className="col-xxl-7 col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12">
              <div className="py-md-5 pt-4 text-center text-md-start">
                <h4 className="pb-3 pb-xl-5">
                  <strong>
                    Dear {username},
                    The report will be e-mailed to you at {globalEmailID}
...
export default Market_Snapshot_Download;
